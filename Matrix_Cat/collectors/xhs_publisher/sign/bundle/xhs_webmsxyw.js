...
document = {
    ...
    documentElement : {},
    cookie:'abRequestId=d2884811-7945-5d58-9090-3389be1be778; a1=18ff0ff0f90gxz5rkqw13znc8kazjn2i8ecng3jn950000111398; webId=10c883903f86a3d21b8f33f14d1b475e; gid=yYii8iiy2DY2yYii8ii8idqVj8kCu2FTAEyqSIjuISYT0I28uVIJ3k888yyyqjY8jdjDWyS4; xsecappid=xhs-pc-web; webBuild=4.27.7; unread={%22ub%22:%22668229d80000000005007f3b%22%2C%22ue%22:%226696b6240000000025001f2a%22%2C%22uc%22:9}; websectiga=cf46039d1971c7b9a650d87269f31ac8fe3bf71d61ebf9d9a0a87efb414b816c; sec_poison_id=67e28156-db11-48e2-9fb3-820093d1b70f',
...
navigator = {
    ...
    webdriver:"false",
    appName: "Netscape",
    appVersion: "5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Mobile Safari/537.36",
    languages:[
    "zh-CN",
    "zh"
],
...
function Decrypt(c,i,a1){
    document.cookie='abRequestId=d2884811-7945-5d58-9090-3389be1be778; a1='+a1+'; webId=10c883903f86a3d21b8f33f14d1b475e; gid=yYii8iiy2DY2yYii8ii8idqVj8kCu2FTAEyqSIjuISYT0I28uVIJ3k888yyyqjY8jdjDWyS4; xsecappid=xhs-pc-web; webBuild=4.27.7; unread={%22ub%22:%22668229d80000000005007f3b%22%2C%22ue%22:%226696b6240000000025001f2a%22%2C%22uc%22:9}; websectiga=cf46039d1971c7b9a650d87269f31ac8fe3bf71d61ebf9d9a0a87efb414b816c; sec_poison_id=67e28156-db11-48e2-9fb3-820093d1b70f'
    return window._webmsxyw(c,i)
}

// console.log(window._webmsxyw("/api/sns/web/v1/homefeed",{
//     "cursor_score": "1.7249019259610028E9",
//     "num": 18,
//     "refresh_type": 3,
//     "note_index": 34,
...
/* ==== Matrix_Cat 接线:导出纯函数签名(不带任何 console 演示)==== */
;(function(){
  try{
    var _origCookie = (typeof document!=='undefined' && document.cookie) || '';
    globalThis.__xhs_sign = function(path, data, a1){
      if(a1 && typeof document!=='undefined'){
        // 用本号 a1 覆盖 cookie 里的 a1(兜底:有些实现从 document.cookie 读 a1)
        document.cookie = _origCookie.replace(/a1=[^;]*/, 'a1='+a1);
      }
      return window._webmsxyw(path, data, a1);   // a1 作第 3 参,与线上调用一致
    };
  }catch(e){}
})();
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { sign: globalThis.__xhs_sign };
}
